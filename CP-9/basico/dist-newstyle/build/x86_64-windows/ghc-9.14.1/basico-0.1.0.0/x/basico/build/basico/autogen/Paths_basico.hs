...
-- at runtime using the environment variable basico_bindir.
...
-- environment variable basico_libdir.
...
-- using the environment variable basico_dynlibdir.
...
-- runtime using the environment variable basico_datadir.
...
-- using the environment variable basico_sysconfdir.
...
bindir     = "C:\\cabal\\bin"
libdir     = "C:\\cabal\\x86_64-windows-ghc-9.14.1-bd8b\\basico-0.1.0.0-inplace-basico"
dynlibdir  = "C:\\cabal\\x86_64-windows-ghc-9.14.1-bd8b"
datadir    = "C:\\cabal\\x86_64-windows-ghc-9.14.1-bd8b\\basico-0.1.0.0"
libexecdir = "C:\\cabal\\basico-0.1.0.0-inplace-basico\\x86_64-windows-ghc-9.14.1-bd8b\\basico-0.1.0.0"
sysconfdir = "C:\\cabal\\etc"

getBinDir     = catchIO (getEnv "basico_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "basico_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "basico_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "basico_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "basico_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "basico_sysconfdir") (\_ -> return sysconfdir)
